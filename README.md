...
3D printed cases for type C and H **Waveshare 7 inch LCD displays** were printed these Waveshare 7 inch LCD HDMI 1024x600 displays [**type (C)**](https://www.waveshare.com/7inch-hdmi-lcd-c.htm) and [**type (H**](https://www.waveshare.com/7hp-capqled.htm). These were based on the [**design here**](https://www.thingiverse.com/thing:3743598), and the front and back files STL are included here in the folder models.
